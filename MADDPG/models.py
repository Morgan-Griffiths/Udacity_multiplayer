...
class Critic(nn.Module):
    def __init__(self,seed,nO,nA,hidden_dims=(256,128)):
        super(Critic,self).__init__()
        self.seed = torch.manual_seed(seed)
        self.nO = nO
        self.nA = nA
        
        self.input_layer = nn.Linear(nO,hidden_dims[0])
        self.action_layer = nn.Linear(nA,hidden_dims[0])
...
class Actor(nn.Module):
    def __init__(self,seed,nS,nA,hidden_dims=(128,128)):
